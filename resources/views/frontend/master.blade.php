            ...
            <div class="container">
               ...
               <nav class="main-menu">
                  <ul class="l-inline ov">
                     ...
                     <?php
                        $data_menu_cap_1 = DB::table('cates')->where('parent_id',0)->get();

                     ?>
                     @foreach ($data_menu_cap_1 as $item_level_1)
                     <li>
                        <a href="{!! URL::route('loaisanpham',['id'=>$item_level_1->id,'alias'=>$item_level_1->alias]) !!}">{!! $item_level_1->name !!}</a>
                        <ul class="sub-menu">
                            <?php
                                $menu_level_2 = DB::table('cates')->where('parent_id', $item_level_1->id)->get();
                            ?>
                            @foreach ($menu_level_2 as $item_level_2)
                                <li><a href="{!! URL::route('loaisanpham',['id'=>$item_level_2->id,'alias'=>$item_level_2->alias]) !!}">{!! $item_level_2->name !!}</a></li>                            
                            @endforeach
                        </ul>
                     </li>
                     @endforeach
