		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{asset('frontend/')}}">Home</a> / <span>Product</span>
				</div>
			</div>
		...
		<div id="content">
			<div class="row">
				<div class="col-sm-9">
					<div class="row">
						<div class="col-sm-4">
							<img src="{{asset('public/upload/image/'.$product_detail->image)}}" alt="">
						</div>
						<div class="col-sm-8">
						...
						<div class="widget-body">
							<div class="beta-sales beta-lists">
								...
								<div class="media beta-sales-item">
										<a class="pull-left" href="{!! URL::route('getdetail',['id' => $item->id, 'alias' => $item->alias]) !!}"><img src="{{asset('public/upload/image/'. $item->image)}}" alt=""></a>
										<div class="media-body">
											{{ $item->name }}
											<p class="beta-sales-price">{{number_format($item->price, 0, ",", ".")}} VNĐ</p>
										</div>
									</div>
								@endforeach
							</div>
